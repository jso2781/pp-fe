                    ...
                    <div className="info-summary-box">
                      ...
                      <div className="info-summary-box__desc">
                         <div className="img-switcher">
                          <img src="/img/safetyTerms_img01.png" alt="이미지설명" className="responsive-img pc-only"/>
                          <img src="/img/safetyTerms_img01_m.png"  alt="" aria-hidden="true" className="responsive-img mo-only"/>
                        </div>
                        <div  className="mb24"></div> 
