                  ...
                  <section className="pageCont-introCI">
                    <div className="section-desc">
                      <div className="intro-ci">
                        <div className="img-box"><img src="/fe/img/cms/en/introCI_img01.png" alt="KIDS" /></div>
                    ...
                    <div className="section-desc">
                      <div className="logo-grid">
                          <div className="logo-item">
                            ...
                            <div className="logo-signature">
                              <img src="/fe/img/cms/en/introCI_img02.png" alt="English CI " />
                            </div>
                          </div>
                          <div className="logo-item">
                            <span className="logo-label">English+Korean</span>
                            <div className="logo-signature">
                              <img src="/fe/img/cms/en/introCI_img03.png" alt="English+Korean CI" />
                            </div>
                          </div>
                          <div className="logo-item">
                            <span className="logo-label">Korean</span>
                            <div className="logo-signature">
                              <img src="/fe/img/cms/en/introCI_img04.png" alt="Korean CI" />
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="section-desc sec03">
                        ...
                        {/* <a href="/download/" download className="btn-down">
                          <img src="/fe/img/cms/en/ico_pdf.png" alt="pdf" />
                          <span>CI Mamual file download</span>
                        </a> 
                        <a href="/download/" download className="btn-down">
                          <img src="/fe/img/cms/en/ico_ai.png" alt="ai" />
