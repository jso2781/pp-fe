                    ...
                    <Box className="board-header">
                      ...
                      <Box className="board-info">
                        <ul className="info-list">
                          ...
                          <li>
                            <span className="info-label">Registrate Date</span>
                        ...
                        <ul className="attachment-list">
                          ...
                          <li key={index}>
                            <Link 
                              ...
                              underline="none"
                              title="attachfile download"
                              onClick={() => handleDownload(file.atchFileId ?? '')}
                            >
                              <Box className="file-info">
                                <span className="file-label">{atchFiles.length === 1 ? 'Attach File' : `Attach File${index + 1}`}</span>
