...
import { selectTrmsSttListApiPath, getTrmsSttApiPath, insertTrmsSttApiPath, updateTrmsSttApiPath, saveTrmsSttApiPath, deleteTrmsSttApiPath } from '@/api/stt/TrmsSttApiPaths'
