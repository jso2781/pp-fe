              ...
              <section className="pageCont-dur-intro">
                ...
                <ul className="definition-list">
                  ...
                  <li className="definition-list__item">
                    <Box className="definition-list__icon">
                      <img src="/img/ico_dur_01.png" alt="병용금기 성분 아이콘" />
                    </Box>
                    <Box className="definition-list__text">
                ...
                <Box className="info-action-list">
                  <Box className="info-action-item">
                    <Box className="info-action-item__text-group">
                    ...
                    <Box className="info-action__btn">
                      <Button 
                        variant="text" 
                        className="btn-link" 
