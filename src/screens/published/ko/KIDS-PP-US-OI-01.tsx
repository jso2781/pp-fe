                      ...
                      <section id="anchor-sec3" className="tab-section" role="tabpanel" tabIndex={0} aria-labelledby="tab3">
                        <div className="inner-box">
                          ...
                          <div className="img-switcher">
                            <img src="/fe/img/cms/taskProgress_img01.png" alt="청구절차 도식화" className="responsive-img pc-only"/>
                            <img src="/fe/img/cms/taskProgress_img01_m.png"  alt="" aria-hidden="true" className="responsive-img mo-only"/>
                          </div>
