                ...
                <Dialog
                  ...
                  >
                    ...
                    <Box className="agreement-section">
                      ...
                      <RadioGroup row name="agreement1" sx={{ justifyContent: 'flex-end' }}>
                    ...
                    <Box className="agreement-section">
                      ...
                      <RadioGroup row name="agreement2" sx={{ justifyContent: 'flex-end' }}>
                        <FormControlLabel value="yes" control={<Radio />} label="동의함" />
                        <FormControlLabel value="no" control={<Radio />} label="동의하지 않음" />
                      </RadioGroup>
                    </Box>
                    <Box className="agreement-section">
                      ...
                      <RadioGroup row name="agreement3" sx={{ justifyContent: 'flex-end' }}>
                        <FormControlLabel value="yes" control={<Radio />} label="동의함" />
                        <FormControlLabel value="no" control={<Radio />} label="동의하지 않음" />
                      </RadioGroup>
                    </Box>
                    <Box className="agreement-section">
                      ...
                      <RadioGroup row name="agreement4" sx={{ justifyContent: 'flex-end' }}>
                        <FormControlLabel value="yes" control={<Radio />} label="동의함" />
                        <FormControlLabel value="no" control={<Radio />} label="동의하지 않음" />
                      </RadioGroup>
                    </Box>
