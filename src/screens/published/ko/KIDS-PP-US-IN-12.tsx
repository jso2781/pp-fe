                  ...
                  <section className="pageCont-AboutCi">
                    ...
                    <div className="section-desc sec01">
                      <div className="logo-signature">
                        <img src="/fe/img/cms/aboutCi_img01.png" alt="CI 로고" />
                      </div>
                    ...
                    <div className="section-desc sec02">
                      ...
                      <div className="logo-grid">
                        <div className="logo-item">
                          ...
                          <div className="logo-signature">
                            <img src="/fe/img/cms/aboutCi_img02.png" alt="영문 CI 로고" />
                          </div>
                        </div>
                        <div className="logo-item">
                          <span className="logo-label">영문+국문</span>
                          <div className="logo-signature">
                            <img src="/fe/img/cms/aboutCi_img03.png" alt="영문+국문 CI 로고" />
                          </div>
                        </div>
                        <div className="logo-item">
                          <span className="logo-label">국문</span>
                          <div className="logo-signature">
                            <img src="/fe/img/cms/aboutCi_img04.png" alt="국문 CI 로고" />
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="section-desc sec03">
                      ...
                      <div className="logo-signature">
                        <div className="signature-item">
                          <div className="desc-logo">
                            <img src="/fe/img/cms/aboutCi_img05.png" alt="단색조합 슬로건" />
                          </div>
                          <span className="logo-caption">[단색조합]</span>
                        </div>
                        <div className="signature-item">
                          <div className="desc-logo">
                            <img src="/fe/img/cms/aboutCi_img05.png" alt="그라데이션 슬로건" />
                          </div>
                      ...
                      <div className="section-desc">
                        ...
                        <div className="logo-signature">
                          <img src="/fe/img/cms/aboutCi_img07.png" alt="국문지정서체" />
                        </div>
                      </div>
                    </div>
                  </section>
