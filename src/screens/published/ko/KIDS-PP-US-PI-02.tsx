                ...
                {/* --- 본문 시작 --- */}
                  ...
                  <section className="pageCont-AdverseKaers">
                    ...
                    <div className="img-switcher">
                      <img src="/fe/img/cms/adverseKaers_img01.png" alt="의약품이상사례보고시스템 (PC)" className="responsive-img pc-only"/>
                      <img src="/fe/img/cms/adverseKaers_img01_m.png"  alt="의약품이상사례보고시스템 (모바일)" className="responsive-img mo-only"/>
                    </div>
