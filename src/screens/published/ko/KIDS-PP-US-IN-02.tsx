                    ...
                    <div className="former-list">
                      <div className="box">
                        <div className="thumbnail">
                          <img src="/fe/img/cms/aboutForme_img01.png" alt="4대 원장 오정완" />
                        </div> 
                      ...
                      <div className="box">
                        <div className="thumbnail">
                          <img src="/fe/img/cms/aboutForme_img02.png" alt="3대 원장 한순영" />
                        </div>
                        <div className="former-info">
                      ...
                      <div className="box">
                        <div className="thumbnail">
                          <img src="/fe/img/cms/aboutForme_img03.png" alt="2대 원장 구본기" />
                        </div>
                        <div className="former-info">
                      ...
                      <div className="box">
                        <div className="thumbnail">
                          <img src="/fe/img/cms/aboutForme_img04.png" alt="1대 원장 박병주" />
                        </div>
                        <div className="former-info">
