                    ...
                    <div className="info-summary-box">
                      ...
                      <div className="info-summary-box__desc">
                         <div className="img-switcher">
                          <img src="/fe/img/cms/safetyTerms_img01.png" alt="약물감시 도식화" className="responsive-img pc-only"/>
                          <img src="/fe/img/cms/safetyTerms_im g01_m.png"  alt="" aria-hidden="true" className="responsive-img mo-only"/>
                        </div>
                        <div  className="mb24"></div> 
