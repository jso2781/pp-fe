                ...
                {/* --- 본문 시작 --- */}
                  ...
                  <section className="pageCont-introKAERS">
                    ...
                    <div className="img-switcher">
                      <img src="/fe/img/cms/en/introKAERS_img01.png" alt="" className="responsive-img pc-only"/>
                      <img src="/fe/img/cms/en/introKAERS_img01_m.png"  alt="" aria-hidden="true" className="responsive-img mo-only"/>
                    </div>
